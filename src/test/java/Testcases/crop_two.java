...
//    action.press(start,y).moveTo(end,y).release().perform();
    ...
    action.press(PointOption.point(start,y)).moveTo(PointOption.point(moveTo, y)).release().perform();
		 ...
		 if(rotateViewText.contains("14.8")) {
		 ...
		 apply_crop.click();
		 screenshot("Image rotated clockwise");
		 undo(2,undo);
		 footer_options.get(0).click();
		// rotate_view.click();
...
//   action.press(start,y).moveTo(end,y).release().perform();
   ...
   action.press(PointOption.point(start,y)).moveTo(PointOption.point(moveTo, y)).release().perform();
		 ...
		 if(rotateViewText.contains("-13.8")) {
		 ...
		 apply_crop.click();
		 screenshot("Image rotated anti-clockwise");
		 undo(3,undo);
	//	 footer_options.get(0).click();
	  ...
	  public void G_Testcase7() throws InterruptedException, IOException {
		...
		// TouchAction actions=new TouchAction(driver);
		 ...
		 for(int i=0;i<4;i++) {
			 ...
			 Thread.sleep(2000);
			 apply_crop.click();
			 screenshot("Crop grid "+(i+1)+"applied");
			 undo(i+4,undo);
			 wait(save_img_view);
			 if(save_img_view.isDisplayed()==true) {
	...
	*/
		 ...
		 for(int i=0;i<4;i++) {
			 ...
			 Thread.sleep(2000);
			 apply_crop.click();
			 screenshot("Crop grid "+(i+5)+"applied");
			 undo(i+8,undo);
			 wait(save_img_view);
			 if(save_img_view.isDisplayed()==true) {
	...
	//		 if(i!=0 && i % 4 == 0) {
		...
		wait(footer_options.get(0));
		 ...
		 for(int i=0;i<4;i++) {
			 ...
			 Thread.sleep(2000);
			 apply_crop.click();
			 screenshot("Crop grid "+(i+9)+"applied");
			 undo(i,undo);
			 wait(save_img_view);
			 if(save_img_view.isDisplayed()==true) {
	...
	//		 if(i!=0 && i % 4 == 0) {
		 ...
		 for(int i=0;i<2;i++) {
			 ...
			 Thread.sleep(2000);
			 apply_crop.click();
			 screenshot("Crop grid "+(i+13)+"applied");
			 undo(i+5,undo);
			 wait(save_img_view);
			 if(save_img_view.isDisplayed()==true) {
